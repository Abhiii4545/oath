...
const ITEMS = [
  { n: '01', title: 'Podcasts', desc: 'Long-form conversation, unscripted.', tag: 'Audio' },
  { n: '02', title: 'Clothing', desc: 'Wearable ideas, made in small runs.', tag: 'Supply' },
  { n: '03', title: 'Events', desc: 'Rooms built for people, not feeds.', tag: 'Live' },
  { n: '04', title: 'Creative', desc: 'Film, print, design, experiments.', tag: 'Studio' },
  { n: '05', title: 'Future', desc: 'The parts we haven’t named yet.', tag: 'Open' },
]
